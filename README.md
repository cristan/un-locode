...
[The original UN/LOCODE list](https://github.com/datasets/un-locode) has 2 major problems regarding coordinates:
...
You can find the improved list as [code-list-improved.csv](data/code-list-improved.csv). It has both corrected coordinates, as well as just way more of them (97.46%).
