...
You can find the improved list as [code-list-improved.csv](data/code-list-improved.csv). It has both corrected coordinates, as well as just way more coordinates (97.18% have coordinates. The ones who don't are mostly small villages).
